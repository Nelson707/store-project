                    ...
                    <div className="space-y-8">
                        ...
                        <div className="pt-8 space-y-4">
                            <div className="flex space-x-4">
                                <button className="flex-1 px-8 py-3.5 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">
                                    Add to Cart
                                </button>
