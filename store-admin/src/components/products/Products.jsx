...
//                             {selectedCategory
//                                 ? `Showing products in "${selectedCategory.name}" (${filteredProducts.length})`
...
//                         <h3 className="text-lg font-medium text-gray-800">Filter by Category</h3>
//                     </div>
...
//                                 <div>
//                                     <p className="font-medium text-blue-800">Active Filter</p>
...
//                                             </td>
//                                             <td className="px-6 py-4 whitespace-nowrap">
//                                                 <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${p.stockQuantity > 20
...
//                                 {selectedCategory && ` in "${selectedCategory.name}" category`}
//                             </div>
//                             <div className="flex items-center gap-4">
//                                 {selectedCategory && (
//                                     <button
...
//                                 )}
//                                 <div className="text-sm text-gray-600">
//                                     Total: <span className="font-medium">{products.length}</span> products in database
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
